...
import { Mail, User, KeyRound, CircleX } from 'lucide-react'
      ...
      <div className="card bg-base-300 max-w-md shadow-sm">
        <div className="card-body p-12">
          <div className='flex justify-center items-center flex-col'>
            <p className="card-title text-2xl px-4">Create an Account</p>
          ...
          <div className='mt-4 text-center'>
            <p className='text-base-content/70'>
              ...
              <Link to="/signin" className='ml-2 link link-primary'>Sign in</Link>
            </p>
          </div>
        </div>
      </div>
